...
public abstract class FrameworkConstants {
    ...
    public static final String ADD_AUTH_FAILURE_REASON_TO_REDIRECT_URL = "EnableAddingAuthFailureReasonToRedirectURL";
    public static final String ENABLE_MULTI_OPTION_FOR_API_BASED_RESPONSE = "EnableMultiOptionForAPIBasedResponse";
