...
public interface APIResourceManagementDAO {
    ...
    /**
     * Update the {@link Scope} metadata by scope id.
     *
     * @param scope       Scope.
     * @param apiResource API resource.
     * @param tenantId    Tenant Id.
     * @throws APIResourceMgtException If an error occurs while updating the scope metadata.
     */
    ...
    /**
     * Delete the {@link Scope} for the given scope id.
     *
     * @param apiId    API resource id.
     * @param scopeId  Scope id.
     * @param tenantId Tenant Id.
