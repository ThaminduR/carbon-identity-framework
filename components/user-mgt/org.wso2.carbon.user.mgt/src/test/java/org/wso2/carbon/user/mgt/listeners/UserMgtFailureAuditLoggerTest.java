...
public class UserMgtFailureAuditLoggerTest {
    ...
    /**
     * Issue #6955 regression — direct unit test of the private helper
     * {@code getErrorMessageWithMaskedUsername} via reflection. Asserts the four corners of the new null-guard:
     * <ul>
     *   <li>both args null → return null (no NPE);</li>
     *   <li>null errorMessage with non-null userName → return null;</li>
     *   <li>non-null errorMessage with null userName → return the original errorMessage unchanged;</li>
     *   <li>non-null errorMessage with empty userName → return the original errorMessage unchanged.</li>
     * </ul>
     */
